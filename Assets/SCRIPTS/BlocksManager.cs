...
void Update()
    ...
    {
        float ScreenWeightWorldPos = Camera.main.orthographicSize * Screen.width / Screen.height;
        float distBetweenBlocks = ScreenWeightWorldPos / 5;
        for (int i=-2;i<3;i++)
        {
    ...
    {
        float screenWightWorldPos = Camera.main.orthographicSize * Screen.width / Screen.height;
        float distBetweenBlocks = screenWightWorldPos / 5;
